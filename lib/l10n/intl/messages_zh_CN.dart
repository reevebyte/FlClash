...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(line) => "第${line}行的节点分享链接无效";
  ...
  static String m30(scheme) => "不支持的节点分享链接协议：${scheme}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "importFromURL": MessageLookupByLibrary.simpleMessage("从URL或节点分享链接导入"),
    ...
    "urlDesc": MessageLookupByLibrary.simpleMessage("通过URL或节点分享链接获取配置文件"),
    "urlTip": m31,
